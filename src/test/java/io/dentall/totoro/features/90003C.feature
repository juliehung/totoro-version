...
Feature: 90003C 恆牙根管治療（三根）
    ...
    Scenario Outline: （HIS）60 天內，曾經有 90015C 治療項目
        ...
        Examples:
            | IssueNhiCode | IssueTeeth | IssueSurface | PastTreatmentDays | TreatmentNhiCode | TreatmentTeeth | PassOrNot |
            | 90003C       | 11         | MOB          | 59                | 90015C           | 11             | Pass      |
            | 90003C       | 11         | MOB          | 60                | 90015C           | 11             | Pass      |
            | 90003C       | 11         | MOB          | 61                | 90015C           | 11             | NotPass   |
    ...
    Scenario Outline: （HIS）病患牙齒是否有 90003C 健保代碼於60天內已被申報過
        Given 建立醫師
        Given Wind 24 歲病人
        Given 在過去第 60 天，建立預約
        Given 在過去第 60 天，建立掛號
    ...
    Scenario Outline: （IC）病患牙齒是否有 90003C 健保代碼於60天內已被申報過
        Given 建立醫師
        Given Wind 24 歲病人
        Given 在過去第 60 天，建立預約
        Given 在過去第 60 天，建立掛號
    ...
    Scenario Outline: （HIS）病患牙齒是否有 90001C~90003C/90019C~90020C 健保代碼於90天前已被申報過
        ...
        Examples:
            ...
            | 90003C       | 11         | MOB          | 90       | 89                | 90002C           | 11             | NotPass   | NotPass        |
            ...
            | 90003C       | 11         | MOB          | 90       | 89                | 90002C           | 14             | Pass      | Pass           |
            ...
            | 90003C       | 11         | MOB          | 90       | 90                | 90003C           | 11             | NotPass   | NotPass        |
            ...
            | 90003C       | 11         | MOB          | 90       | 91                | 90003C           | 11             | Pass      | Pass           |
