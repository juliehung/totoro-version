...
Feature: 總人數(有診察費) 不重複病患且不為預防保健、同療
    ...
    Scenario: 計算PT2看診人數 (CardNumber為數字)
        ...
        When 設定指標資料
            ...
            |            | 2020-06-15   | 00317C   | 635       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
            |            | 2020-06-30   | 0        |           | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | 001        | 009         | Jerry       | 50            |                 |              |
    ...
    Scenario: 計算PT2看診人數 (CardNumber為Prevention Code)
        ...
        When 設定指標資料
            ...
            |            | 2020-06-01   | 00317C   | 635       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        |            |             | Jerry       | 50            |                 |              |
            |            | 2020-06-15   | 00317C   | 635       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | IC001      |             | Jerry       | 50            |                 |              |
            |            | 2020-06-30   | 0        |           | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | IC001      | 009         | Jerry       | 50            |                 |              |
    ...
    Scenario: 計算PT2看診人數 (CardNumber為Error Code)
        ...
        When 設定指標資料
            ...
            |            | 2020-06-01   | 00317C   | 635       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        |            |             | Jerry       | 50            |                 |              |
            |            | 2020-06-15   | 00317C   | 635       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | D001       |             | Jerry       | 50            |                 |              |
            |            | 2020-06-30   | 0        |           | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | D001       | 009         | Jerry       | 50            |                 |              |
