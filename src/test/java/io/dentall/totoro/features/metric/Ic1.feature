...
Feature: 卡數 處置單有診察費且有卡號或異常代碼，不重複計算
    ...
    Scenario: 計算Ic1卡數 (CardNumber為數字)
        ...
        When 設定指標資料
            ...
            |            | 2020-06-01   | 00317C   |           | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
    ...
    Scenario: 計算Ic1卡數 (CardNumber為Prevention Code)
        ...
        When 設定指標資料
            ...
            |            | 2020-06-01   | 00317C   |           | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | IC001      |             | Jerry       | 50            |                 |              |
    ...
    Scenario: 計算Ic1卡數 (CardNumber為Error Code)
        ...
        When 設定指標資料
            ...
            |            | 2020-06-01   | 00317C   |           | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | D001       |             | Jerry       | 50            |                 |              |
