...
Feature: OD1-ReToothCount
    ...
    Scenario: 計算OD1-ReToothCount 單人 單顆
        ...
        Then 指定執行日期 2020-05-01，補牙時間範圍 OdQuarterByPatientSource／重補時間範圍 OdOneYearNearByPatientSource，檢查 Od1ReToothCount，計算結果數值應為 1
    ...
    Scenario: 計算OD1-ReToothCount 多人 單顆
        ...
        Then 指定執行日期 2020-05-01，補牙時間範圍 OdQuarterByPatientSource／重補時間範圍 OdOneYearNearByPatientSource，檢查 Od1ReToothCount，計算結果數值應為 3
    ...
    Scenario: 計算OD1-ReToothCount 多人 多顆
        ...
        Then 指定執行日期 2020-05-01，補牙時間範圍 OdQuarterByPatientSource／重補時間範圍 OdOneYearNearByPatientSource，檢查 Od1ReToothCount，計算結果數值應為 6
