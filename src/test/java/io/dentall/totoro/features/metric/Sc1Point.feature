...
Feature: 洗牙
    ...
    Scenario: 計算SC1洗牙點數
        ...
        When 設定指標資料
            ...
            |            | 2020-05-01   | 00315C   | 635       | 91003C | 150   | 1000        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
            |            | 2020-05-02   | 00316C   | 635       | 91004C | 600   | 400         | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
            |            | 2020-05-03   | 00317C   | 635       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
