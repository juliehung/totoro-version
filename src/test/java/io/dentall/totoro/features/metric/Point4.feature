...
Feature: 部分負擔點數
    ...
    Scenario: 計算Point4點數
        ...
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Point4，計算結果數值應為 150
    ...
    Scenario: 計算Point4點數 部份負擔為0
        ...
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Point4，計算結果數值應為 0
    ...
    Scenario: 計算Point4ByDaily點數
        ...
        When 設定指標資料
            ...
            |            | 2020-05-03   | 00317C   | 100       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
        Then 指定執行日期 2020-05-01，來源資料使用 DailyByMonthSelectedSource，檢查 Point4ByDaily，每日數值
            | Date       | Value |
            | 2020-05-01 | 100   |
            | 2020-05-02 | 100   |
            | 2020-05-03 | 100   |
