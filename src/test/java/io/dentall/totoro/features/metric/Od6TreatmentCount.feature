...
Feature: OD6-TreatmentCount
    ...
    Scenario: 計算OD6-TreatmentCount 多人
        ...
        When 設定指標資料
            ...
            | 4          | 2020-05-03   | 00317C   | 635       | 89012C | 1050  | 1050        | 1112  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
            | 4          | 2020-05-03   | 00317C   | 635       | 89012C | 1050  | 1050        | 1314  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
            | 11         | 2020-05-11   | 00315C   | 635       | 89003C | 750   | 750         | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
            | 11         | 2020-05-11   | 00315C   | 635       | 89010C | 1000  | 1000        | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
            | 13         | 2020-05-12   | 00316C   | 635       | 89010C | 1000  | 1000        | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
            | 14         | 2020-05-13   | 00317C   | 635       | 89012C | 1050  | 1050        | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
            | 14         | 2020-05-13   | 00317C   | 635       | 89012C | 1050  | 1050        | 1314  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
        Then 指定執行日期 2020-05-01，來源資料使用 OdMonthSelectedSource，檢查 Od4TreatmentCount，計算結果數值應為 0
        Then 指定執行日期 2020-05-01，來源資料使用 OdMonthSelectedSource，檢查 Od5TreatmentCount，計算結果數值應為 0
