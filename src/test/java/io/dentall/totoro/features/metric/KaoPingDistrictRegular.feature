...
Feature: 高屏區指標
    ...
    Scenario Outline: 高屏區指標
        ...
        Examples:
            | Date       | Formula     | Value    |
            | 2021-05-01 | K1Formula   | 76060.00 |
            | 2021-05-01 | K2Formula   | 471.75   |
            | 2021-05-01 | K11Formula  | 1.08     |
            | 2021-05-01 | J2h5Formula | 15.38    |
            | 2021-05-01 | K10Formula  | 2.17     |
            | 2021-05-01 | K3Formula   | 1363.89  |
            | 2021-05-01 | K4Formula   | 31.64    |
            | 2021-05-01 | K5Formula   | 0.30     |
            | 2021-05-01 | K6Formula   | 0.00     |
            | 2021-05-01 | K7Formula   | 0.00     |
            | 2021-05-01 | K12Formula  | 0.09     |
