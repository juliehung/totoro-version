...
Feature: 一般牙科門診診察費(不含Xray)
  ...
  Scenario: 計算Exam1點數
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam1，計算結果數值應為 4340
  ...
  Scenario: 計算Exam1點數，使用00121C點數計算
    ...
    When 設定指標資料
      ...
      | 14         | 2020-05-13   | 00303C   | 320       | 89001C | 450   | 450         | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
      | 15         | 2020-05-13   | 00304C   | 200       | 89001C | 450   | 450         | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam1，計算結果數值應為 3450
  ...
  Scenario: 計算Exam1點數，排除山地離島診察費差額
    ...
    When 設定指標資料
      ...
      | 14         | 2020-05-13   | 00303C   | 320       | 89001C | 450   | 450         | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
      | 15         | 2020-05-13   | 00304C   | 200       | 89001C | 450   | 450         | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam1，計算結果數值應為 4280
  ...
  Scenario: 計算Exam1每日點數
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 每日1個月，檢查 Exam1ByDaily，每日數值
      | Date       | Value |
      | 2020-05-01 | 460   |
      | 2020-05-03 | 240   |
      | 2020-05-05 | 520   |
