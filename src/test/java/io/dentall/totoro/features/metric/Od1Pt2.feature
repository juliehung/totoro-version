...
Feature: OD1-PT2
  ...
  Scenario: 計算OD1-PT2看診人數 (CardNumber為數字)
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 OD季，檢查 Od1Pt2，計算結果數值應為 7
  ...
  Scenario: 計算OD1-PT2看診人數 (CardNumber為Prevention Code)
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 OD季，檢查 Od1Pt2，計算結果數值應為 0
  ...
  Scenario: 計算OD1-PT2看診人數 (CardNumber為Error Code)
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 OD季，檢查 Od1Pt2，計算結果數值應為 8
