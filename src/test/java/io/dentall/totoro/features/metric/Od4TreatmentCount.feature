...
Feature: OD4-TreatmentCount
  ...
  Scenario: 計算OD4-TreatmentCount 單人
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 OdMonthSelectedSource，檢查 Od4TreatmentCount，計算結果數值應為 5
  ...
  Scenario: 計算OD4-TreatmentCount 多人
    ...
    When 設定指標資料
      ...
      | 4          | 2020-05-03   | 00317C   | 635       | 89011C | 400   | 400         | 1112  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
      | 4          | 2020-05-03   | 00317C   | 635       | 89011C | 400   | 400         | 1314  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
      | 11         | 2020-05-11   | 00315C   | 635       | 89001C | 450   | 450         | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
      | 11         | 2020-05-11   | 00315C   | 635       | 89004C | 500   | 500         | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
      | 13         | 2020-05-12   | 00316C   | 635       | 89008C | 600   | 600         | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
      | 14         | 2020-05-13   | 00317C   | 635       | 89011C | 400   | 400         | 1112  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
      | 14         | 2020-05-13   | 00317C   | 635       | 89011C | 400   | 400         | 1314  | MOD     | OTHER        | 001        |             | Danny       | 50            |                 |              |
    Then 指定執行日期 2020-05-01，來源資料使用 OdMonthSelectedSource，檢查 Od4TreatmentCount，計算結果數值應為 10
    Then 指定執行日期 2020-05-01，來源資料使用 OdMonthSelectedSource，檢查 Od5TreatmentCount，計算結果數值應為 0
    Then 指定執行日期 2020-05-01，來源資料使用 OdMonthSelectedSource，檢查 Od6TreatmentCount，計算結果數值應為 0
