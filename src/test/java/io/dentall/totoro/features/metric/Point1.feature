...
Feature: 合計點數
    ...
    Scenario: 計算Point1點數
        ...
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource／MonthSelectedDisposalSource，檢查 Point1，計算結果數值應為 4355
    ...
    Scenario: 計算Point1ByDaily點數
        ...
        When 設定指標資料
            ...
            |            | 2020-05-03   | 00317C   | 100       | 89112C | 1050  | 1050        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
        Then 指定執行日期 2020-05-01，來源資料使用 DailyByMonthSelectedSource／DailyByMonthSelectedDisposalSource，檢查 Point1ByDaily，每日數值
            | Date       | Value |
            | 2020-05-01 | 2200  |
            | 2020-05-02 | 1000  |
            | 2020-05-03 | 2300  |
