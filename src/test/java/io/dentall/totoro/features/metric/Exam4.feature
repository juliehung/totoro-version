...
Feature: 符合牙醫門診加強感染管制實施方案之牙科門診診察費(Xray)
    ...
    Scenario: 計算Exam4點數
        ...
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Exam4，計算結果數值應為 1905
    ...
    Scenario: 計算Exam4點數，使用00121C點數計算
        ...
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Exam2，計算結果數值應為 0
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Exam3，計算結果數值應為 0
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Exam4，計算結果數值應為 690
    ...
    Scenario: 計算Exam4點數，使用00121C點數計算/Exam2和Exam4，超過1200萬點納入計算
        ...
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Exam2，計算結果數值應為 0
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Exam3，計算結果數值應為 0
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedSource，檢查 Exam4，計算結果數值應為 12001500
