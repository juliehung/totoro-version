...
Feature: 符合牙醫門診加強感染管制實施方案之牙科門診診察費(不含Xray)
  ...
  Scenario: 計算Exam3點數
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam3，計算結果數值應為 3300
  ...
  Scenario: 計算Exam3點數，使用00121C點數計算
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam1，計算結果數值應為 0
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam2，計算結果數值應為 0
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam3，計算結果數值應為 2300
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam4，計算結果數值應為 0
  ...
  Scenario: 計算Exam3點數，排除山地離島診察費差額
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam1，計算結果數值應為 0
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam2，計算結果數值應為 0
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam3，計算結果數值應為 3240
    Then 指定執行日期 2020-05-01，來源資料使用 1個月，檢查 Exam4，計算結果數值應為 0
  ...
  Scenario: 計算Exam3每日點數
    ...
    Then 指定執行日期 2020-05-01，來源資料使用 每日1個月，檢查 Exam3ByDaily，每日數值
      | Date       | Value |
      | 2020-05-01 | 710   |
      | 2020-05-03 | 310   |
      | 2020-05-05 | 770   |
