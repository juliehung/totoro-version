...
Feature: 根管EndoTreatmentByTooth
  ...
  Scenario: 計算EndoTreatmentByTooth
    ...
    When 設定指標資料
      ...
      | 5          | 2020-05-05   | 00317C   | 635       | 90016C | 1010  | 1010        | 1112  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
      | 6          | 2020-05-06   | 00317C   | 635       | 90018C | 1690  | 1690        | 1112  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
      | 7          | 2020-05-07   | 00317C   | 635       | 90019C | 4810  | 4810        | 1112  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
      | 8          | 2020-05-08   | 00317C   | 635       | 90020C | 6010  | 6010        | 1112  | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
