...
Feature: 初診 Xray 診察費差額
    ...
    Scenario: 計算Point6點數
        ...
        When 設定指標資料
            ...
            |            | 2020-05-13   | 01271C   | 600       | 89110C | 1000  | 1000        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
            |            | 2020-05-13   | 01272C   | 600       | 89110C | 1000  | 1000        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
            |            | 2020-05-13   | 01273C   | 600       | 89110C | 1000  | 1000        | 11    | MOD     | OTHER        | 001        |             | Jerry       | 50            |                 |              |
        ...
        Then 指定執行日期 2020-05-01，來源資料使用 MonthSelectedDisposalSource，檢查 Point6，計算結果數值應為 2325
