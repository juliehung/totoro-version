...
Feature: 89001C 銀粉充填 － 單面
    ...
    Scenario Outline: （HIS）同牙位前30天內不得有89006C，但如果這中間有90001C, 90002C, 90003C, 90019C, 90020C則例外
        ...
        Examples:
            ...
            | 89001C       | 51         | MOB          | 15                | 01271C           | 52             | 30                 | Pass      |
            ...
            | 89001C       | 51         | MOB          | 29                | 90001C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90002C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90003C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90019C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90020C           | 52             | 30                 | Pass      |
            ...
            | 89001C       | 51         | MOB          | 31                | 90001C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 31                | 90002C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 31                | 90003C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 31                | 90019C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 31                | 90020C           | 52             | 30                 | Pass      |
            ...
            | 89001C       | 51         | MOB          | 30                | 90001C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 30                | 90002C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 30                | 90003C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 30                | 90019C           | 52             | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 30                | 90020C           | 52             | 30                 | Pass      |
