Feature: 89001C 銀粉充填 － 單面
    ...
    Scenario Outline: （HIS）未曾申報過 90007C 代碼
        ...
        Examples:
            ...
            | 89001C       | 51         | MOB          | 30                | 90007C           | NotPass   |
            | 89001C       | 51         | MOB          | 30                | 01271C           | Pass      |
    ...
    Scenario Outline: 前30天內不得有89006C，但如果這中間有90001C, 90002C, 90003C, 90019C, 90020C則例外
        ...
        Examples:
            ...
            | 89001C       | 51         | MOB          | 15                | 01271C           | 30                 | NotPass   |
            # 測試89006C在超過30天前建立
            | 89001C       | 51         | MOB          | 15                | 01271C           | 31                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內
            | 89001C       | 51         | MOB          | 29                | 90001C           | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90002C           | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90003C           | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90019C           | 30                 | Pass      |
            | 89001C       | 51         | MOB          | 29                | 90020C           | 30                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天
            | 89001C       | 51         | MOB          | 31                | 90001C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 31                | 90002C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 31                | 90003C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 31                | 90019C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 31                | 90020C           | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天
            | 89001C       | 51         | MOB          | 30                | 90001C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 30                | 90002C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 30                | 90003C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 30                | 90019C           | 30                 | NotPass   |
            | 89001C       | 51         | MOB          | 30                | 90020C           | 30                 | NotPass   |
    ...
    Scenario Outline: 檢查治療的牙位是否為 GENERAL_TOOTH
        ...
        Examples:
            ...
            | 89001C       | 99         | MOB          | Pass      |
            # 牙位為區域型態
            | 89001C       | FM         | MOB          | NotPass   |
            # 非法牙位
            | 89001C       | 00         | MOB          | NotPass   |
            | 89001C       | 01         | MOB          | NotPass   |
            | 89001C       | 10         | MOB          | NotPass   |
            | 89001C       | 56         | MOB          | NotPass   |
            | 89001C       | 66         | MOB          | NotPass   |
            | 89001C       | 76         | MOB          | NotPass   |
            | 89001C       | 86         | MOB          | NotPass   |
            | 89001C       | 91         | MOB          | NotPass   |
