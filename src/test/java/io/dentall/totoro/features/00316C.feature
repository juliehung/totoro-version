Feature: 00316C 符合牙醫門診加強感染管制實施方案之年度初診X光檢查
    ...
    Scenario Outline: （HIS）365天內沒有任何治療紀錄及545天內沒有00316C治療記錄
        ...
        Examples:
            ...
            | 00316C       | 11         | DO           | 364                  | 545                     | 545              | NotPass   |
            | 00316C       | 11         | DO           | 365                  | 545                     | 545              | NotPass   |
            | 00316C       | 11         | DO           | 366                  | 545                     | 545              | Pass      |
            | 00316C       | 11         | DO           | 364                  | 546                     | 545              | Pass      |
            | 00316C       | 11         | DO           | 365                  | 546                     | 545              | Pass      |
            | 00316C       | 11         | DO           | 366                  | 546                     | 545              | Pass      |
    ...
    Scenario Outline: （HIS）365天內，不應有 01271C/01272C/01273C/00315C/00317C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
    ...
    Scenario Outline: （IC）365天內，不應有 01271C/01272C/01273C/00315C/00317C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
