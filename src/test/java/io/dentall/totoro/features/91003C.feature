...
Feature: 91003C 牙結石清除－局部
    ...
    Scenario Outline: （HIS）90天內，不應有 91003C/91005C/91015C~91018C/91089C/91103C~91105C 診療項目
        Given 建立醫師
        Given Stan 24 歲病人
        Given 在過去第 <PastTreatmentDays> 天，建立預約
        Given 在過去第 <PastTreatmentDays> 天，建立掛號
        ...
        Examples:
            ...
            | 91003C       | UR         | DL           | 89                | 91089C           | UL             | 90     | NotPass   |
            | 91003C       | UR         | DL           | 90                | 91089C           | UL             | 90     | NotPass   |
            | 91003C       | UR         | DL           | 91                | 91089C           | UL             | 90     | Pass      |
    ...
    Scenario Outline: （IC）90天內，不應有 91003C/91005C/91015C~91018C/91089C/91103C~91105C 診療項目
        Given 建立醫師
        Given Stan 24 歲病人
        Given 新增健保醫療:
            | PastDays          | NhiCode          | Teeth          |
    ...
    Scenario Outline: （HIS）180天內，不應有 91004C 診療項目
        Given 建立醫師
        Given Stan 24 歲病人
        Given 在過去第 <PastTreatmentDays> 天，建立預約
        Given 在過去第 <PastTreatmentDays> 天，建立掛號
        ...
        Examples:
            | IssueNhiCode | IssueTeeth | IssueSurface | PastTreatmentDays | TreatmentNhiCode | TreatmentTeeth | GapDay | PassOrNot |
            | 91003C       | UR         | DL           | 179                | 91004C           | FM             | 180     | NotPass   |
            | 91003C       | UR         | DL           | 180                | 91004C           | FM             | 180     | NotPass   |
            | 91003C       | UR         | DL           | 181                | 91004C           | FM             | 180     | Pass      |

    Scenario Outline: （IC）180天內，不應有 91004C 診療項目
        Given 建立醫師
        Given Stan 24 歲病人
        Given 新增健保醫療:
            | PastDays          | NhiCode          | Teeth          |
