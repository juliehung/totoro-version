...
Feature: 89115C 特殊狀況之後牙雙鄰接面複合樹脂充填
    ...
    Scenario Outline: （HIS）同牙位前30天內不得有89006C，但如果這中間有90001C, 90002C, 90003C, 90019C, 90020C則例外
        ...
        Examples:
            ...
            | 89115C       | 14         | MOBL         | 15                | 01271C           | 14             | 30                 | NotPass   |
            # 測試TreatmentNhiCode為非指定代碼且不同牙位
            | 89115C       | 14         | MOBL         | 15                | 01271C           | 15             | 30                 | Pass      |
            # 測試89006C在超過30天前建立且同牙位
            | 89115C       | 14         | MOBL         | 15                | 01271C           | 14             | 31                 | Pass      |
            # 測試89006C在超過30天前建立且不同牙位
            | 89115C       | 14         | MOBL         | 15                | 01271C           | 15             | 31                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且同牙位
            | 89115C       | 14         | MOBL         | 29                | 90001C           | 14             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90002C           | 14             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90003C           | 14             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90019C           | 14             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90020C           | 14             | 30                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且不同牙位
            | 89115C       | 14         | MOBL         | 29                | 90001C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90002C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90003C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90019C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 29                | 90020C           | 15             | 30                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且同牙位
            | 89115C       | 14         | MOBL         | 31                | 90001C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 31                | 90002C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 31                | 90003C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 31                | 90019C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 31                | 90020C           | 14             | 30                 | NotPass   |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且不同牙位
            | 89115C       | 14         | MOBL         | 31                | 90001C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 31                | 90002C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 31                | 90003C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 31                | 90019C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 31                | 90020C           | 15             | 30                 | Pass      |
            # 測試TreatmentNhiCode與89006C都在同一天且同牙位
            | 89115C       | 14         | MOBL         | 30                | 90001C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 30                | 90002C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 30                | 90003C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 30                | 90019C           | 14             | 30                 | NotPass   |
            | 89115C       | 14         | MOBL         | 30                | 90020C           | 14             | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天且不同牙位
            | 89115C       | 14         | MOBL         | 30                | 90001C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 30                | 90002C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 30                | 90003C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 30                | 90019C           | 15             | 30                 | Pass      |
            | 89115C       | 14         | MOBL         | 30                | 90020C           | 15             | 30                 | Pass      |
    ...
    Scenario Outline: 檢查治療的牙位是否為 BACK_TOOTH
        ...
        Examples:
            ...
            | 89115C       | UB         | DL           | NotPass   |
            | 89115C       | LR         | DL           | NotPass   |
            | 89115C       | LL         | DL           | NotPass   |
            | 89115C       | LA         | DL           | NotPass   |
            | 89115C       | LB         | DL           | NotPass   |
            # 非法牙位
            | 89115C       | 00         | DL           | NotPass   |
            | 89115C       | 01         | DL           | NotPass   |
            | 89115C       | 10         | DL           | NotPass   |
            | 89115C       | 56         | DL           | NotPass   |
            | 89115C       | 66         | DL           | NotPass   |
            | 89115C       | 76         | DL           | NotPass   |
            | 89115C       | 86         | DL           | NotPass   |
            | 89115C       | 91         | DL           | NotPass   |
