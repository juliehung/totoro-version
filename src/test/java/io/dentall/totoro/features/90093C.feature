...
Feature: 90093C 難症特別處理-根管特別彎曲、根管鈣化，器械斷折（非同一醫療院所)，以根管數計算
    ...
    Scenario Outline: （Disposal）同日得同時有 90001C~90003C/90019C/90020C
        ...
        Examples:
            ...
            | 90093C       | 11         | MOB          | 90002C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 90003C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 90019C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 90020C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 01271C           | 11             | MOB              | NotPass   |
    ...
    Scenario Outline: （HIS-Today）同日得同時有 90001C~90003C/90019C/90020C
        ...
        Examples:
            ...
            | 90093C       | 11         | MOB          | 當日                | 90001C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 當日                | 90002C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 當日                | 90003C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 當日                | 90019C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 當日                | 90020C           | 11             | MOB              | Pass      |
            | 90093C       | 11         | MOB          | 昨日                | 90001C           | 11             | MOB              | NotPass   |
            | 90093C       | 11         | MOB          | 昨日                | 90002C           | 11             | MOB              | NotPass   |
            | 90093C       | 11         | MOB          | 昨日                | 90003C           | 11             | MOB              | NotPass   |
            | 90093C       | 11         | MOB          | 昨日                | 90019C           | 11             | MOB              | NotPass   |
            | 90093C       | 11         | MOB          | 昨日                | 90020C           | 11             | MOB              | NotPass   |
    ...
    Scenario Outline: （IC）同日得同時有 90001C~90003C/90019C/90020C
        ...
        Examples:
            ...
            | 90093C       | 11         | MOB          | 當日              | 90001C         | 11           | Pass      |
            | 90093C       | 11         | MOB          | 當日              | 90002C         | 11           | Pass      |
            | 90093C       | 11         | MOB          | 當日              | 90003C         | 11           | Pass      |
            | 90093C       | 11         | MOB          | 當日              | 90019C         | 11           | Pass      |
            | 90093C       | 11         | MOB          | 當日              | 90020C         | 11           | Pass      |
            | 90093C       | 11         | MOB          | 昨日              | 90001C         | 11           | NotPass   |
            | 90093C       | 11         | MOB          | 昨日              | 90002C         | 11           | NotPass   |
            | 90093C       | 11         | MOB          | 昨日              | 90003C         | 11           | NotPass   |
            | 90093C       | 11         | MOB          | 昨日              | 90019C         | 11           | NotPass   |
            | 90093C       | 11         | MOB          | 昨日              | 90020C         | 11           | NotPass   |
    ...
    Scenario Outline: 檢查治療的牙位是否為 PERMANENT_TOOTH
        ...
        Examples:
            | IssueNhiCode | IssueTeeth | IssueSurface | PassOrNot |
            # 乳牙
            | 90093C       | 51         | DL           | NotPass   |
            | 90093C       | 52         | DL           | NotPass   |
            | 90093C       | 53         | DL           | NotPass   |
            | 90093C       | 54         | DL           | NotPass   |
            | 90093C       | 55         | DL           | NotPass   |
            | 90093C       | 61         | DL           | NotPass   |
            | 90093C       | 62         | DL           | NotPass   |
            | 90093C       | 63         | DL           | NotPass   |
            | 90093C       | 64         | DL           | NotPass   |
            | 90093C       | 65         | DL           | NotPass   |
            | 90093C       | 71         | DL           | NotPass   |
            | 90093C       | 72         | DL           | NotPass   |
            | 90093C       | 73         | DL           | NotPass   |
            | 90093C       | 74         | DL           | NotPass   |
            | 90093C       | 75         | DL           | NotPass   |
            | 90093C       | 81         | DL           | NotPass   |
            | 90093C       | 82         | DL           | NotPass   |
            | 90093C       | 83         | DL           | NotPass   |
            | 90093C       | 84         | DL           | NotPass   |
            | 90093C       | 85         | DL           | NotPass   |
            # 恆牙
            | 90093C       | 11         | DL           | Pass      |
            | 90093C       | 12         | DL           | Pass      |
            | 90093C       | 13         | DL           | Pass      |
            ...
            | 90093C       | 39         | DL           | Pass      |
            | 90093C       | 49         | DL           | Pass      |
            | 90093C       | 59         | DL           | NotPass   |
            | 90093C       | 69         | DL           | NotPass   |
            | 90093C       | 79         | DL           | NotPass   |
            | 90093C       | 89         | DL           | NotPass   |
            | 90093C       | 99         | DL           | Pass      |
            # 牙位為區域型態
            ...
            | 90093C       | 10         | DL           | NotPass   |
            | 90093C       | 56         | DL           | NotPass   |
            | 90093C       | 66         | DL           | NotPass   |
            | 90093C       | 76         | DL           | NotPass   |
            | 90093C       | 86         | DL           | NotPass   |
            | 90093C       | 91         | DL           | NotPass   |
