...
Feature: 92098C 顱顎關節障礙特殊檢查費-複診
    ...
    Scenario Outline: （HIS）30天內，不應有 92098C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        ...
        Examples:
            ...
            | 92098C       | 11         | DL           | 29                | 92098C           | 11             | 30     | NotPass   |
            | 92098C       | 11         | DL           | 30                | 92098C           | 11             | 30     | NotPass   |
            | 92098C       | 11         | DL           | 31                | 92098C           | 11             | 30     | Pass      |

    Scenario Outline: （IC）30天內，不應有 92098C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
