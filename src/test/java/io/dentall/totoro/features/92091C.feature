@nhi-92-series
Feature: 92091C 非定期性口腔癌與癌前病變追蹤治療
    ...
    Scenario Outline: （HIS）180天內，不應有 92091C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        ...
        Examples:
            ...
            | 92091C       | 11         | DL           | 179               | 92091C           | 11             | 180    | NotPass   |
            | 92091C       | 11         | DL           | 180               | 92091C           | 11             | 180    | NotPass   |
            | 92091C       | 11         | DL           | 181               | 92091C           | 11             | 180    | Pass      |

    Scenario Outline: （IC）180天內，不應有 92091C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
    ...
    Scenario Outline: （Disposal）同日不得同時有 92090C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 建立預約
        Given 建立掛號
        ...
        Examples:
            ...
            | 92091C       | 11         | MOB          | 92090C           | 11             | MOB              | NotPass   |

    Scenario Outline: （HIS-Today）同日不得同時有 92090C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        ...
        Examples:
            ...
            | 92091C       | 11         | MOB          | 當日                | 92090C           | 11             | MOB              | NotPass   |
            | 92091C       | 11         | MOB          | 昨日                | 92090C           | 11             | MOB              | Pass      |

    Scenario Outline: （IC）同日不得同時有 92090C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
        ...
        Examples:
            ...
            | 92091C       | 11         | MOB          | 當日              | 92090C         | 11           | NotPass   |
            | 92091C       | 11         | MOB          | 昨日              | 92090C         | 11           | Pass      |
