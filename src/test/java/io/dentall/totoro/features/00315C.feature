...
Feature: 00315C 符合牙醫門診加強感染管制實施方案之環口全景X光初診診察
    ...
    Scenario Outline: （HIS）365天內，不應有 01271C/01272C/01273C/00316C/00317C 診療項目 (無視他家)
        Given 建立醫師
        Given Scott 24 歲病人
        Given 在過去第 <PastTreatmentDays> 天，建立預約
        Given 在過去第 <PastTreatmentDays> 天，建立掛號
    ...
    Scenario Outline: （IC）365天內，不應有 01271C/01272C/01273C/00316C/00317C 診療項目 (無視他家)
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
            | PastDays          | NhiCode          | Teeth          |
        ...
        Examples:
            ...
            | 00315C       | 11         | MOB          | 364             | 01271C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 365             | 01271C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 366             | 01271C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 364             | 01272C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 365             | 01272C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 366             | 01272C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 364             | 01273C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 365             | 01273C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 366             | 01273C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 364             | 00316C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 365             | 00316C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 366             | 00316C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 364             | 00317C         | 11           | 365    | Pass      |
            | 00315C       | 11         | MOB          | 365             | 00317C         | 11           | 365    | Pass      |
    ...
    Scenario Outline: （IC）365天內，不應有 P6701C 診療項目 (包含他家)
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
            | PastDays          | NhiCode          | Teeth          |
