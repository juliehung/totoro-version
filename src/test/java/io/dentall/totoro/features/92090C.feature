...
Feature: 92090C 定期性口腔癌與癌前病變追蹤治療
    ...
    Scenario Outline: （HIS）60天內，不應有 92090C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
    ...
    Scenario Outline: （HIS-Today）同日不得同時有 92091C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        ...
        Examples:
            ...
            | 92090C       | 11         | MOB          | 昨日                | 92091C           | 11             | MOB              | Pass      |

    Scenario Outline: （IC）同日不得同時有 92091C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
        ...
        Examples:
            ...
            | 92090C       | 11         | MOB          | 昨日              | 92091C         | 11           | Pass      |
