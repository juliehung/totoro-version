...
Feature: 89109C 特殊狀況之後牙複合樹脂充填-雙面
    ...
    Scenario Outline: （HIS）同牙位前30天內不得有89006C，但如果這中間有90001C, 90002C, 90003C, 90019C, 90020C則例外
        ...
        Examples:
            ...
            | 89109C       | 54         | MOB          | 15                | 01271C           | 54             | 30                 | NotPass   |
            # 測試TreatmentNhiCode為非指定代碼且不同牙位
            | 89109C       | 54         | MOB          | 15                | 01271C           | 55             | 30                 | NotPass   |
            # 測試89006C在超過30天前建立且同牙位
            | 89109C       | 54         | MOB          | 15                | 01271C           | 54             | 31                 | Pass      |
            # 測試89006C在超過30天前建立且不同牙位
            | 89109C       | 54         | MOB          | 15                | 01271C           | 55             | 31                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且同牙位
            | 89109C       | 54         | MOB          | 29                | 90001C           | 54             | 30                 | Pass      |
            | 89109C       | 54         | MOB          | 29                | 90002C           | 54             | 30                 | Pass      |
            | 89109C       | 54         | MOB          | 29                | 90003C           | 54             | 30                 | Pass      |
            | 89109C       | 54         | MOB          | 29                | 90019C           | 54             | 30                 | Pass      |
            | 89109C       | 54         | MOB          | 29                | 90020C           | 54             | 30                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且不同牙位
            | 89109C       | 54         | MOB          | 29                | 90001C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 29                | 90002C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 29                | 90003C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 29                | 90019C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 29                | 90020C           | 55             | 30                 | NotPass   |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且同牙位
            | 89109C       | 54         | MOB          | 31                | 90001C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90002C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90003C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90019C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90020C           | 54             | 30                 | NotPass   |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且不同牙位
            | 89109C       | 54         | MOB          | 31                | 90001C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90002C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90003C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90019C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 31                | 90020C           | 55             | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天且同牙位
            | 89109C       | 54         | MOB          | 30                | 90001C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90002C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90003C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90019C           | 54             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90020C           | 54             | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天且不同牙位
            | 89109C       | 54         | MOB          | 30                | 90001C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90002C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90003C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90019C           | 55             | 30                 | NotPass   |
            | 89109C       | 54         | MOB          | 30                | 90020C           | 55             | 30                 | NotPass   |
    ...
    Scenario Outline: 檢查治療的牙位是否為 BACK_TOOTH
        ...
        Examples:
            ...
            | 89109C       | 39         | DL           | Pass      |
            | 89109C       | 49         | DL           | Pass      |
            | 89109C       | 59         | DL           | NotPass   |
            | 89109C       | 69         | DL           | NotPass   |
            | 89109C       | 79         | DL           | NotPass   |
            | 89109C       | 89         | DL           | NotPass   |
            | 89109C       | 99         | DL           | Pass      |
            # 牙位為區域型態
            | 89109C       | FM         | DL           | NotPass   |
            | 89109C       | UR         | DL           | NotPass   |
            | 89109C       | UL         | DL           | NotPass   |
            | 89109C       | UA         | DL           | NotPass   |
            | 89109C       | UB         | DL           | NotPass   |
            | 89109C       | LL         | DL           | NotPass   |
            | 89109C       | LR         | DL           | NotPass   |
            | 89109C       | LA         | DL           | NotPass   |
            | 89109C       | LB         | DL           | NotPass   |
            # 非法牙位
