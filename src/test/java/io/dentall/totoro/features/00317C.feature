...
Feature: 00317C 符合牙醫門診加強感染管制實施方案之高齲齒罹患率族群年度初診X光片檢查
    ...
    Scenario Outline: （IC）365天內，不應有 00317C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
    ...
    Scenario Outline: （HIS）365天內，不應有 01271C/01272C/01273C/00315C/00316C/P6701C 診療項目
        Given 建立醫師
        Given Scott 11 歲病人
        Given 在過去第 <PastTreatmentDays> 天，建立預約
        Given 在過去第 <PastTreatmentDays> 天，建立掛號
        ...
        Examples:
            ...
            | 00317C       | 11         | MOB          | 364               | P6701C           | 11             | MOB              | 365    | NotPass   |
            | 00317C       | 11         | MOB          | 365               | P6701C           | 11             | MOB              | 365    | NotPass   |
            | 00317C       | 11         | MOB          | 366               | P6701C           | 11             | MOB              | 365    | Pass      |

    Scenario Outline: （IC）365天內，不應有 01271C/01272C/01273C/00315C/00316C/P6701C 診療項目
        Given 建立醫師
        Given Kelly 11 歲病人
        Given 新增健保醫療:
            | PastDays          | NhiCode          | Teeth          |
        ...
        Examples:
            ...
            | 00317C       | 11         | MOB          | 364             | P6701C         | 11           | 365    | NotPass   |
            | 00317C       | 11         | MOB          | 365             | P6701C         | 11           | 365    | NotPass   |
            | 00317C       | 11         | MOB          | 366             | P6701C         | 11           | 365    | Pass      |
