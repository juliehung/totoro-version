...
Feature: 91104C 特殊狀況牙結石清除-全口
    ...
    Scenario Outline: （HIS）90天內，不應有 91003C/91005C/91015C/91016C/91017C/91018C/91089C/P6702C/P6703C/P6704C/P6705C 診療項目
        Given 建立醫師
        Given Kelly 24 歲病人
        Given 在過去第 <PastTreatmentDays> 天，建立預約
        Given 在過去第 <PastTreatmentDays> 天，建立掛號
        ...
        Examples:
            ...
            | 91104C       | 11         | DL           | 89                | P6702C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 90                | P6702C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 91                | P6702C           | 11             | 90     | Pass      |
            | 91104C       | 11         | DL           | 89                | P6703C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 90                | P6703C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 91                | P6703C           | 11             | 90     | Pass      |
            | 91104C       | 11         | DL           | 89                | P6704C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 90                | P6704C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 91                | P6704C           | 11             | 90     | Pass      |
            | 91104C       | 11         | DL           | 89                | P6705C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 90                | P6705C           | 11             | 90     | NotPass   |
            | 91104C       | 11         | DL           | 91                | P6705C           | 11             | 90     | Pass      |

    Scenario Outline: （IC）90天內，不應有 91003C/91005C/91015C/91016C/91017C/91018C/91089C/P6702C/P6703C/P6704C/P6705C 診療項目
        Given 建立醫師
        Given Kelly 24 歲病人
        Given 新增健保醫療:
            | PastDays          | NhiCode          | Teeth          |
