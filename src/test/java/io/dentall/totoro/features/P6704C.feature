...
Feature: P6704C 嚴重齲齒兒童口腔健康照護複診治療-第二次
    ...
    Scenario Outline: 全部檢核成功
        ...
        Examples:
            ...
            | 90                | P6703C           | 11             | MOB              | P6704C       | 11         | MOB          | Pass      |
    ...
    Scenario Outline: （Disposal）不得與91014C、91020C、91114C、92051B、92072C、P30002、81、87同時申報
        ...
        Examples:
            ...
            | P6742C       | 11         | MOB          | 91014C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 91020C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 91114C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 92051B           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 92072C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | P30002           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 81           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 87           | 11             | MOB              | NotPass   |
    ...
    Scenario Outline: （HIS-Today）不得與91014C、91020C、91114C、92051B、92072C、P30002、81、87同時申報
        ...
        Examples:
            ...
            | P6742C       | 11         | MOB          | 當日                | 91014C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 91020C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 91114C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 92051B           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 92072C           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | P30002           | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 81               | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 87               | 11             | MOB              | NotPass   |
            | P6742C       | 11         | MOB          | 昨日                | 91014C           | 11             | MOB              | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 91020C           | 11             | MOB              | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 91114C           | 11             | MOB              | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 92051B           | 11             | MOB              | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 92072C           | 11             | MOB              | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | P30002           | 11             | MOB              | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 81               | 11             | MOB              | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 87               | 11             | MOB              | Pass      |
    ...
    Scenario Outline: （IC）不得與91014C、91020C、91114C、92051B、92072C、P30002、81、87同時申報
        ...
        Examples:
            ...
            | P6742C       | 11         | MOB          | 當日                | 91014C           | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 91020C           | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 91114C           | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 92051B           | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 92072C           | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | P30002           | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 81               | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 當日                | 87               | 11           | NotPass   |
            | P6742C       | 11         | MOB          | 昨日                | 91014C           | 11           | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 91020C           | 11           | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 91114C           | 11           | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 92051B           | 11           | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 92072C           | 11           | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | P30002           | 11           | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 81               | 11           | Pass      |
            | P6742C       | 11         | MOB          | 昨日                | 87               | 11           | Pass      |
