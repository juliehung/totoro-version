...
Feature: 91114C 特殊牙周暨齲齒控制基本處置
    ...
    Scenario Outline: （HIS）90天內，不應有 P6702C、P6703C、P6704C、P6705C 診療項目
        ...
        Examples:
            | IssueNhiCode | IssueTeeth | IssueSurface | PastTreatmentDays | TreatmentNhiCode | TreatmentTeeth | GapDay | PassOrNot |
            | 91114C       | FM         | DL           | 89                | P6702C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 89                | P6703C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 89                | P6704C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 89                | P6705C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 90                | P6702C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 90                | P6703C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 90                | P6704C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 90                | P6705C           | FM             | 90     | NotPass   |
            | 91114C       | FM         | DL           | 91                | P6702C           | FM             | 90     | Pass      |
            | 91114C       | FM         | DL           | 91                | P6703C           | FM             | 90     | Pass      |
            | 91114C       | FM         | DL           | 91                | P6704C           | FM             | 90     | Pass      |
            | 91114C       | FM         | DL           | 91                | P6705C           | FM             | 90     | Pass      |
