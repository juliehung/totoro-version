...
Feature: 90097C 難症特別處理-符合附表3.3.1標準之多根管根管治療。(四根管)
    ...
    Scenario Outline: （Disposal）同日得同時有 90001C~90003C/90019C/90020C
        ...
        Examples:
            ...
            | 90097C       | 11         | MOB          | 90002C           | 11             | MOB              | Pass      |
    ...
    Scenario Outline: （HIS-Today）同日得同時有 90001C~90003C/90019C/90020C
        ...
        Examples:
            ...
            | 90097C       | 11         | MOB          | 當日                | 90001C           | 11             | MOB              | Pass      |
            | 90097C       | 11         | MOB          | 當日                | 90002C           | 11             | MOB              | Pass      |
            | 90097C       | 11         | MOB          | 當日                | 90003C           | 11             | MOB              | Pass      |
            | 90097C       | 11         | MOB          | 當日                | 90019C           | 11             | MOB              | Pass      |
            | 90097C       | 11         | MOB          | 當日                | 90020C           | 11             | MOB              | Pass      |
            | 90097C       | 11         | MOB          | 昨日                | 90001C           | 11             | MOB              | NotPass   |
            | 90097C       | 11         | MOB          | 昨日                | 90002C           | 11             | MOB              | NotPass   |
            | 90097C       | 11         | MOB          | 昨日                | 90003C           | 11             | MOB              | NotPass   |
            | 90097C       | 11         | MOB          | 昨日                | 90019C           | 11             | MOB              | NotPass   |
            | 90097C       | 11         | MOB          | 昨日                | 90020C           | 11             | MOB              | NotPass   |
    ...
    Scenario Outline: （IC）同日得同時有 90001C~90003C/90019C/90020C
        ...
        Examples:
            ...
            | 90097C       | 11         | MOB          | 當日              | 90001C         | 11           | Pass      |
            | 90097C       | 11         | MOB          | 當日              | 90002C         | 11           | Pass      |
            | 90097C       | 11         | MOB          | 當日              | 90003C         | 11           | Pass      |
            | 90097C       | 11         | MOB          | 當日              | 90019C         | 11           | Pass      |
            | 90097C       | 11         | MOB          | 當日              | 90020C         | 11           | Pass      |
            | 90097C       | 11         | MOB          | 昨日              | 90001C         | 11           | NotPass   |
            | 90097C       | 11         | MOB          | 昨日              | 90002C         | 11           | NotPass   |
            | 90097C       | 11         | MOB          | 昨日              | 90003C         | 11           | NotPass   |
            | 90097C       | 11         | MOB          | 昨日              | 90019C         | 11           | NotPass   |
            | 90097C       | 11         | MOB          | 昨日              | 90020C         | 11           | NotPass   |
    ...
    Scenario Outline: 檢查治療的牙位是否為 PERMANENT_TOOTH
        ...
        Examples:
            | IssueNhiCode | IssueTeeth | IssueSurface | PassOrNot |
            # 乳牙
            | 90097C       | 51         | DL           | NotPass   |
            | 90097C       | 52         | DL           | NotPass   |
            | 90097C       | 53         | DL           | NotPass   |
            | 90097C       | 54         | DL           | NotPass   |
            | 90097C       | 55         | DL           | NotPass   |
            | 90097C       | 61         | DL           | NotPass   |
            | 90097C       | 62         | DL           | NotPass   |
            | 90097C       | 63         | DL           | NotPass   |
            | 90097C       | 64         | DL           | NotPass   |
            | 90097C       | 65         | DL           | NotPass   |
            | 90097C       | 71         | DL           | NotPass   |
            | 90097C       | 72         | DL           | NotPass   |
            | 90097C       | 73         | DL           | NotPass   |
            | 90097C       | 74         | DL           | NotPass   |
            | 90097C       | 75         | DL           | NotPass   |
            | 90097C       | 81         | DL           | NotPass   |
            | 90097C       | 82         | DL           | NotPass   |
            | 90097C       | 83         | DL           | NotPass   |
            | 90097C       | 84         | DL           | NotPass   |
            | 90097C       | 85         | DL           | NotPass   |
            # 恆牙
            | 90097C       | 11         | DL           | Pass      |
            | 90097C       | 12         | DL           | Pass      |
            | 90097C       | 13         | DL           | Pass      |
            ...
            | 90097C       | 39         | DL           | Pass      |
            | 90097C       | 49         | DL           | Pass      |
            | 90097C       | 59         | DL           | NotPass   |
            | 90097C       | 69         | DL           | NotPass   |
            | 90097C       | 79         | DL           | NotPass   |
            | 90097C       | 89         | DL           | NotPass   |
            | 90097C       | 99         | DL           | Pass      |
            # 牙位為區域型態
            ...
            | 90097C       | 10         | DL           | NotPass   |
            | 90097C       | 56         | DL           | NotPass   |
            | 90097C       | 66         | DL           | NotPass   |
            | 90097C       | 76         | DL           | NotPass   |
            | 90097C       | 86         | DL           | NotPass   |
            | 90097C       | 91         | DL           | NotPass   |
