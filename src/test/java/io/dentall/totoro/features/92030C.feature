...
Feature: 92030C 前齒根尖切除術
    ...
    Scenario Outline: （HIS）730天內，同牙位不應有 92030C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        ...
        Examples:
            ...
            # 不同牙
            | 92030C       | 11         | DL           | 0                 | 92030C           | 12             | 730      | Pass      |
            | 92030C       | 11         | DL           | 729               | 92030C           | 12             | 730      | Pass      |
            | 92030C       | 11         | DL           | 730               | 92030C           | 12             | 730      | Pass      |
            | 92030C       | 11         | DL           | 731               | 92030C           | 12             | 730      | Pass      |
