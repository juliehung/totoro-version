...
Feature: 89014C 前牙雙鄰接面複合樹脂充填
    ...
    Scenario Outline: （HIS）同牙位未曾申報過 90007C 代碼
        ...
        Examples:
            ...
            | 89014C       | 51         | MOBL         | 30                | 90007C           | 51             | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90007C           | 52             | Pass      |
    ...
    Scenario Outline: （HIS）同牙位前30天內不得有89006C，但如果這中間有90001C, 90002C, 90003C, 90019C, 90020C則例外
        ...
        And 新增診療代碼:
            | PastDays             | A72 | A73    | A74              | A75  | A76 | A77 | A78 | A79 |
            | <89006CTreatmentDay> | 3   | 89006C | <TreatmentTeeth> | MOBL | 0   | 1.0 | 03  |     |
        Given 在過去第 <PastTreatmentDays> 天，建立預約
        Given 在過去第 <PastTreatmentDays> 天，建立掛號
        Given 在過去第 <PastTreatmentDays> 天，產生診療計畫
        And 新增診療代碼:
        ...
        Examples:
            ...
            | 89014C       | 51         | MOBL         | 15                | 01271C           | 51             | 30                 | NotPass   |
            # 測試TreatmentNhiCode為非指定代碼且不同牙位
            | 89014C       | 51         | MOBL         | 15                | 01271C           | 52             | 30                 | NotPass   |
            # 測試89006C在超過30天前建立且同牙位
            | 89014C       | 51         | MOBL         | 15                | 01271C           | 51             | 31                 | Pass      |
            # 測試89006C在超過30天前建立且不同牙位
            | 89014C       | 51         | MOBL         | 15                | 01271C           | 52             | 31                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且同牙位
            | 89014C       | 51         | MOBL         | 29                | 90001C           | 51             | 30                 | Pass      |
            | 89014C       | 51         | MOBL         | 29                | 90002C           | 51             | 30                 | Pass      |
            | 89014C       | 51         | MOBL         | 29                | 90003C           | 51             | 30                 | Pass      |
            | 89014C       | 51         | MOBL         | 29                | 90019C           | 51             | 30                 | Pass      |
            | 89014C       | 51         | MOBL         | 29                | 90020C           | 51             | 30                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且不同牙位
            | 89014C       | 51         | MOBL         | 29                | 90001C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 29                | 90002C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 29                | 90003C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 29                | 90019C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 29                | 90020C           | 52             | 30                 | NotPass   |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且同牙位
            | 89014C       | 51         | MOBL         | 31                | 90001C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90002C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90003C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90019C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90020C           | 51             | 30                 | NotPass   |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且不同牙位
            | 89014C       | 51         | MOBL         | 31                | 90001C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90002C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90003C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90019C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 31                | 90020C           | 52             | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天且同牙位
            | 89014C       | 51         | MOBL         | 30                | 90001C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90002C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90003C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90019C           | 51             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90020C           | 51             | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天且不同牙位
            | 89014C       | 51         | MOBL         | 30                | 90001C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90002C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90003C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90019C           | 52             | 30                 | NotPass   |
            | 89014C       | 51         | MOBL         | 30                | 90020C           | 52             | 30                 | NotPass   |
