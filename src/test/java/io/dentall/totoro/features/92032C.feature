...
Feature: 92032C 大臼齒根尖切除術
    ...
    Scenario Outline: （HIS）730天內，同牙位不應有 92032C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        ...
        Examples:
            ...
            # 不同牙
            | 92032C       | 16         | DL           | 0                 | 92032C           | 17             | 730      | Pass      |
            | 92032C       | 16         | DL           | 729               | 92032C           | 17             | 730      | Pass      |
            | 92032C       | 16         | DL           | 730               | 92032C           | 17             | 730      | Pass      |
            | 92032C       | 16         | DL           | 731               | 92032C           | 17             | 730      | Pass      |
