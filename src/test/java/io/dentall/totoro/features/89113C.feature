Feature: 89113C 特殊狀況之複合體充填
    ...
    Scenario Outline: 檢查治療的牙位是否為 FRONT_TOOTH
        ...
        Examples:
            | IssueNhiCode | IssueTeeth | IssueSurface | PassOrNot |
            # 後恆牙
            | 89113C       | 14         | DL           | NotPass   |
            | 89113C       | 15         | DL           | NotPass   |
            | 89113C       | 16         | DL           | NotPass   |
            | 89113C       | 17         | DL           | NotPass   |
            | 89113C       | 18         | DL           | NotPass   |
            | 89113C       | 24         | DL           | NotPass   |
            | 89113C       | 25         | DL           | NotPass   |
            | 89113C       | 26         | DL           | NotPass   |
            | 89113C       | 27         | DL           | NotPass   |
            | 89113C       | 28         | DL           | NotPass   |
            | 89113C       | 34         | DL           | NotPass   |
            | 89113C       | 35         | DL           | NotPass   |
            | 89113C       | 36         | DL           | NotPass   |
            | 89113C       | 37         | DL           | NotPass   |
            | 89113C       | 38         | DL           | NotPass   |
            | 89113C       | 44         | DL           | NotPass   |
            | 89113C       | 45         | DL           | NotPass   |
            | 89113C       | 46         | DL           | NotPass   |
            | 89113C       | 47         | DL           | NotPass   |
            | 89113C       | 48         | DL           | NotPass   |
            # 後乳牙
