Feature: 89002C 銀粉充填 － 雙面
    ...
    Scenario Outline: 檢查治療的牙位是否為 GENERAL_TOOTH
        ...
        Examples:
            ...
            | 89002C       | 99         | MOB          | Pass      |
            # 牙位為區域型態
            | 89002C       | FM         | MOB          | NotPass   |
            # 非法牙位
            | 89002C       | 00         | MOB          | NotPass   |
            | 89002C       | 01         | MOB          | NotPass   |
            | 89002C       | 10         | MOB          | NotPass   |
            | 89002C       | 56         | MOB          | NotPass   |
            | 89002C       | 66         | MOB          | NotPass   |
            | 89002C       | 76         | MOB          | NotPass   |
            | 89002C       | 86         | MOB          | NotPass   |
            | 89002C       | 91         | MOB          | NotPass   |
