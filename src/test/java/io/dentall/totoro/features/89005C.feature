...
Feature: 89005C 前牙複合樹脂充填-雙面
    ...
    Scenario Outline: （HIS）病患同牙位是否有特定健保代碼於365天(乳牙)/545天(恆牙)前已被申報過
        ...
        Examples:
            ...
            # 前乳牙
            | 89005C       | 51         | MOB          | 365      | 0                 | 89001C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 364               | 89001C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89001C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 366               | 89001C           | 51             | Pass      |
            # 前恆牙
            | 89005C       | 11         | MOB          | 545      | 0                 | 89001C           | 11             | NotPass   |
            | 89005C       | 11         | MOB          | 545      | 544               | 89001C           | 11             | NotPass   |
            | 89005C       | 11         | MOB          | 545      | 545               | 89001C           | 11             | NotPass   |
            | 89005C       | 11         | MOB          | 545      | 546               | 89001C           | 11             | Pass      |
            # 申報的牙齒與欲檢查的牙齒不同顆
            | 89005C       | 51         | MOB          | 365      | 0                 | 89001C           | 61             | Pass      |
            | 89005C       | 51         | MOB          | 365      | 364               | 89001C           | 61             | Pass      |
            | 89005C       | 51         | MOB          | 365      | 365               | 89001C           | 61             | Pass      |
            | 89005C       | 11         | MOB          | 545      | 0                 | 89001C           | 21             | Pass      |
            | 89005C       | 11         | MOB          | 545      | 544               | 89001C           | 21             | Pass      |
            | 89005C       | 11         | MOB          | 545      | 545               | 89001C           | 21             | Pass      |
            # 測試其他NhiCode
            | 89005C       | 51         | MOB          | 365      | 365               | 89002C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89003C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89004C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89005C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89008C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89009C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89010C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89011C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89012C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89014C           | 51             | NotPass   |
            | 89005C       | 51         | MOB          | 365      | 365               | 89015C           | 51             | NotPass   |
    ...
    Scenario Outline: （HIS）同牙位未曾申報過 90007C 代碼
        ...
        Examples:
            ...
            | 89005C       | 51         | DL           | 30                | 90007C           | 51             | NotPass   |
            | 89005C       | 51         | DL           | 30                | 90007C           | 52             | Pass      |
    ...
    Scenario Outline: （HIS）同牙位前30天內不得有89006C，但如果這中間有90001C, 90002C, 90003C, 90019C, 90020C則例外
        ...
        Examples:
            ...
            | 89005C       | 51         | MOB          | 15                | 01271C           | 51             | 30                 | NotPass   |
            # 測試TreatmentNhiCode為非指定代碼且不同牙位
            | 89005C       | 51         | MOB          | 15                | 01271C           | 52             | 30                 | NotPass   |
            # 測試89006C在超過30天前建立且同牙位
            | 89005C       | 51         | MOB          | 15                | 01271C           | 51             | 31                 | Pass      |
            # 測試89006C在超過30天前建立且不同牙位
            | 89005C       | 51         | MOB          | 15                | 01271C           | 52             | 31                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且同牙位
            | 89005C       | 51         | MOB          | 29                | 90001C           | 51             | 30                 | Pass      |
            | 89005C       | 51         | MOB          | 29                | 90002C           | 51             | 30                 | Pass      |
            | 89005C       | 51         | MOB          | 29                | 90003C           | 51             | 30                 | Pass      |
            | 89005C       | 51         | MOB          | 29                | 90019C           | 51             | 30                 | Pass      |
            | 89005C       | 51         | MOB          | 29                | 90020C           | 51             | 30                 | Pass      |
            # 測試TreatmentNhiCode是產生在89006C之後，但在30天內且不同牙位
            | 89005C       | 51         | MOB          | 29                | 90001C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 29                | 90002C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 29                | 90003C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 29                | 90019C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 29                | 90020C           | 52             | 30                 | NotPass   |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且同牙位
            | 89005C       | 51         | MOB          | 31                | 90001C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90002C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90003C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90019C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90020C           | 51             | 30                 | NotPass   |
            # 測試TreatmentNhiCode是產生在89006C之前，但超過30天且不同牙位
            | 89005C       | 51         | MOB          | 31                | 90001C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90002C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90003C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90019C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 31                | 90020C           | 52             | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天且同牙位
            | 89005C       | 51         | MOB          | 30                | 90001C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90002C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90003C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90019C           | 51             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90020C           | 51             | 30                 | NotPass   |
            # 測試TreatmentNhiCode與89006C都在同一天且不同牙位
            | 89005C       | 51         | MOB          | 30                | 90001C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90002C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90003C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90019C           | 52             | 30                 | NotPass   |
            | 89005C       | 51         | MOB          | 30                | 90020C           | 52             | 30                 | NotPass   |
    ...
    Scenario Outline: （HIS）同牙未曾申報過 92013C~92015C
        ...
        Examples:
            | IssueNhiCode | IssueTeeth | IssueSurface | PastTreatmentDays | TreatmentNhiCode | TreatmentTeeth | PassOrNot |
            # 測試同牙
            | 89005C       | 51         | DL           | 3650              | 92013C           | 51             | NotPass   |
            | 89005C       | 51         | DL           | 3650              | 92014C           | 51             | NotPass   |
            | 89005C       | 51         | DL           | 3650              | 92015C           | 51             | NotPass   |
            # 測試不同牙
            | 89005C       | 51         | DL           | 3650              | 92013C           | 11             | Pass      |
            | 89005C       | 51         | DL           | 3650              | 92014C           | 11             | Pass      |
            | 89005C       | 51         | DL           | 3650              | 92015C           | 11             | Pass      |
    ...
    Scenario Outline: 檢查治療的牙位是否為 FRONT_TOOTH
        ...
        Examples:
            ...
            | 89005C       | 10         | DL           | NotPass   |
            | 89005C       | 56         | DL           | NotPass   |
            | 89005C       | 66         | DL           | NotPass   |
            | 89005C       | 76         | DL           | NotPass   |
            | 89005C       | 86         | DL           | NotPass   |
            | 89005C       | 91         | DL           | NotPass   |
