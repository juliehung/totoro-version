...
Feature: 91017C 懷孕婦女牙結石清除-全口
    ...
    Scenario Outline: （HIS）90天內，不應有 91003C/91005C/91015C/91016C/91018C/91089C 診療項目
        Given 建立醫師
        Given Kelly 24 歲病人
        Given 在過去第 <PastTreatmentDays> 天，建立預約
        Given 在過去第 <PastTreatmentDays> 天，建立掛號
        ...
        Examples:
            ...
            | 91017C       | FM         | DL           | 89                | 91003C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 90                | 91003C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 91                | 91003C           | FM             | 90     | Pass      |
            | 91017C       | FM         | DL           | 89                | 91005C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 90                | 91005C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 91                | 91005C           | FM             | 90     | Pass      |
            | 91017C       | FM         | DL           | 89                | 91015C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 90                | 91015C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 91                | 91015C           | FM             | 90     | Pass      |
            | 91017C       | FM         | DL           | 89                | 91016C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 90                | 91016C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 91                | 91016C           | FM             | 90     | Pass      |
            | 91017C       | FM         | DL           | 89                | 91018C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 90                | 91018C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 91                | 91018C           | FM             | 90     | Pass      |
            | 91017C       | FM         | DL           | 89                | 91089C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 90                | 91089C           | FM             | 90     | NotPass   |
            | 91017C       | FM         | DL           | 91                | 91089C           | FM             | 90     | Pass      |

    Scenario Outline: （IC）90天內，不應有 91003C/91005C/91015C/91016C/91018C/91089C 診療項目
        Given 建立醫師
        Given Kelly 24 歲病人
        Given 新增健保醫療:
            | PastDays          | NhiCode          | Teeth          |
