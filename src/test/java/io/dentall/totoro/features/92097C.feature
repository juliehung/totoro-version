...
Feature: 92097C 顱顎關節障礙特殊檢查費-初診
    ...
    Scenario Outline: （HIS）1095天內，不應有 92097C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        ...
        Examples:
            ...
            | 92097C       | 11         | DL           | 1094              | 92097C           | 11             | 1095   | NotPass   |
            | 92097C       | 11         | DL           | 1095              | 92097C           | 11             | 1095   | NotPass   |
            | 92097C       | 11         | DL           | 1096              | 92097C           | 11             | 1095   | Pass      |

    Scenario Outline: （IC）1095天內，不應有 92097C 診療項目
        Given 建立醫師
        Given Scott 24 歲病人
        Given 新增健保醫療:
