...
public class DisposalStepDefinition extends AbstractStepDefinition {
    ...
    public void setup() {
        ...
        final DisposalResource resource1 = new DisposalResource(disposalService, disposalQueryService, nhiService, nhiRuleCheckUtil, nhiExtendDisposalRepository);
        ...
        final NhiMedicalRecordResource resource4 = new NhiMedicalRecordResource(nhiMedicalRecordService, nhiMedicalRecordQueryService, nhiTxRepository, nhiMedicineRepository);
