...
public class DataGenerationStepDefinition {
    ...
    public void setup() {
        ...
        final DisposalResource disposalResource = new DisposalResource(disposalService, disposalQueryService, nhiService, nhiRuleCheckUtil, nhiExtendDisposalRepository);
