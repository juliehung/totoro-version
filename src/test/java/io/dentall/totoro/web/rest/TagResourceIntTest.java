...
public class TagResourceIntTest {
    ...
    private static final TagType DEFAULT_TYPE = TagType.ALLERGY;
    private static final TagType UPDATED_TYPE = TagType.DISEASE;
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.isModifiable()).isEqualTo(DEFAULT_MODIFIABLE);
        assertThat(testTag.getOrder()).isEqualTo(DEFAULT_ORDER);
    }
    ...
    public void updateTag() throws Exception {
        ...
        assertThat(testTag.isModifiable()).isEqualTo(UPDATED_MODIFIABLE);
        assertThat(testTag.getOrder()).isEqualTo(UPDATED_ORDER);
    }
