...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_TODO_LIST), REQUEST(ACTION_TYPES.FETCH_TODO)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true
  ...
  describe('Successes', () => {
    it('should fetch all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_TODO_LIST),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_TODO),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_TODO_LIST actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_TODO_LIST)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_TODO_LIST),
    ...
    it('dispatches ACTION_TYPES.FETCH_TODO actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_TODO)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_TODO),
          payload: resolvedObject
