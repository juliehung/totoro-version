...
export const EntitiesMenu = props => (
  ...
  <NavDropdown icon="th-list" name={translate('global.menu.entities.main')} id="entity-menu">
    ...
    <DropdownItem tag={Link} to="/entity/nhi-day-upload">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.nhiDayUpload" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/nhi-day-upload-details">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.nhiDayUploadDetails" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/nhi-extend-patient">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
    ...
    <DropdownItem tag={Link} to="/entity/esign">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.esign" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/marriage-options">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.marriageOptions" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/career-options">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.careerOptions" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/relationship-options">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.relationshipOptions" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/nhi-month-declaration">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.nhiMonthDeclaration" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/nhi-month-declaration-details">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.nhiMonthDeclarationDetails" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/doc-np">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.docNp" />
    </DropdownItem>
    <DropdownItem tag={Link} to="/entity/nhi-accumulated-medical-record">
      <FontAwesomeIcon icon="asterisk" fixedWidth />
      &nbsp;
      <Translate contentKey="global.menu.entities.nhiAccumulatedMedicalRecord" />
    </DropdownItem>
