...
export type IProcedureState = IPaginationBaseState;

export class Procedure extends React.Component<IProcedureProps, IProcedureState> {
  ...
  render() {
    const { procedureList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="procedure-heading">
          <Translate contentKey="totoroApp.procedure.home.title">Procedures</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="totoroApp.procedure.home.createLabel">Create new Procedure</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('content')}>
                  <Translate contentKey="totoroApp.procedure.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('price')}>
                  <Translate contentKey="totoroApp.procedure.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="totoroApp.procedure.procedureType">Procedure Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {procedure.procedureType ? (
                      <Link to={`procedure-type/${procedure.procedureType.id}`}>{procedure.procedureType.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
