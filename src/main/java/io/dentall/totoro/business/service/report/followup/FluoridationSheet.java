...
public class FluoridationSheet extends ExcelSheet {

    private final Counter rowCounter = new Counter();

    private final FluoridationReportSetting setting;

    public FluoridationSheet(FluoridationReportSetting setting) {
