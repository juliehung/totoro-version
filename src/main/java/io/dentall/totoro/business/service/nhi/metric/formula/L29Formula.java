 ...
 * (分子 / 分母) x 100%
 */
public class L29Formula extends AbstractFormula {
    ...
    public L29Formula(Collector collector, Source<OdDto, Map<Long, List<OdDto>>> odQuarterSource, Source<OdDto, Map<Long, List<OdDto>>> odThreeYearNearSource) {
        super(collector);
