...
public class OdQuarterPlusOneYearNearByPatientSource extends AbstractSource<Map<Long, Map<String, List<MetricTooth>>>> {

    public OdQuarterPlusOneYearNearByPatientSource(MetricConfig metricConfig) {
