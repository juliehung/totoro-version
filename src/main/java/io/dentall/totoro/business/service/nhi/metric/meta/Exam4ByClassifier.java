...
public class Exam4ByClassifier extends Exam<Map<Long, Long>> {
    ...
    public Exam4ByClassifier(MetricConfig metricConfig, Source<?, ?> source, Function<MetricTooth, Long> classifier) {
        this(metricConfig, null, source, classifier);
    }

    public Exam4ByClassifier(MetricConfig metricConfig, MetaConfig config, Source<?, ?> source, Function<MetricTooth, Long> classifier) {
