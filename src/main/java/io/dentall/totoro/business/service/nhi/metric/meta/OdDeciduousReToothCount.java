 ...
 */
public class OdDeciduousReToothCount extends AbstractMetaCalculator<Long> {
    ...
    public OdDeciduousReToothCount(MetricConfig metricConfig, Source<?, ?> odSource, Source<?, ?> odPastSource, int dayShiftBegin, int dayShiftEnd) {
        this(metricConfig, null, odSource, odPastSource, dayShiftBegin, dayShiftEnd);
    }

    public OdDeciduousReToothCount(MetricConfig metricConfig, MetaConfig config, Source<?, ?> odSource, Source<?, ?> odPastSource, int dayShiftBegin, int dayShiftEnd) {
