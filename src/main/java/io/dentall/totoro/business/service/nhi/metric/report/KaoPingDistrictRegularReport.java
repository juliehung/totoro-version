...
public class KaoPingDistrictRegularReport {
    ...
    public void generateReport(
        ...
        for (int contentIdx = 0; contentIdx < contents.size(); contentIdx++) {
            ...
            ExcelUtil.createCellAndApplyStyle(sheet, rowIdx++, colIdx, csm.get(ExcelUtil.SupportedCellStyle.REAL_NUMBER), content.getK10().doubleValue());
            ExcelUtil.createCellAndApplyStyle(sheet, rowIdx++, colIdx, csm.get(ExcelUtil.SupportedCellStyle.REAL_NUMBER), content.getK3().doubleValue());
