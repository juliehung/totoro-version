...
public class MonthlyDrugSheet extends ExcelSheet {
    ...
    public void write() {
        ...
        for (SubjectMonthlyDrugVo vo : data) {
            ...
            vo.getSummaryList().forEach(summary -> {
                ...
                cell = row.createCell(cellCounter.get());
                cell.setCellValue(summary.getDrugName());
                cell.setCellStyle(dataCellStyle);

                cell = row.createCell(cellCounter.get());
                cell.setCellValue(summary.getDrugNhiCode());
                cell.setCellStyle(dataCellStyle);
    ...
    private void createHeader(Sheet sheet, Counter rowCounter, Font font, SubjectMonthlyDrugVo vo) {
        ...
        if (vo.getSubjectId() != Long.MIN_VALUE) {
            ...
            sheet.setColumnWidth(3, calculateColumnWith(7, 12));
