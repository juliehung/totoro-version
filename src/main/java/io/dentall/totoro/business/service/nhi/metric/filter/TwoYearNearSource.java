...
import static io.dentall.totoro.business.service.nhi.metric.filter.FilterKey.TwoYearNear;
...
public class TwoYearNearSource extends AbstractSource<NhiMetricRawVM, NhiMetricRawVM> {
    ...
    public TwoYearNearSource(LocalDate date) {
        if (isSameMonth(date)) {
    ...
    public String inputKey() {
        return TwoYearNear.input();
    }

    @Override
    public String outputKey() {
        return TwoYearNear.output();
    }
}
