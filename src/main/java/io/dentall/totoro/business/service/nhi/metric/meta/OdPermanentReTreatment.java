...
public class OdPermanentReTreatment extends AbstractCalculator<Long> {
    ...
    public OdPermanentReTreatment(Collector collector, Source<?, ?> odSource, Source<?, ?> odPastSource, int dayShiftBegin, int dayShiftEnd) {
        this(collector, null, odSource, odPastSource, dayShiftBegin, dayShiftEnd);
    }

    public OdPermanentReTreatment(Collector collector, MetaConfig config, Source<?, ?> odSource, Source<?, ?> odPastSource, int dayShiftBegin, int dayShiftEnd) {
