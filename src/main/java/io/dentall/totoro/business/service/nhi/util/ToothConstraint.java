...
public enum ToothConstraint {
    ...
    PARTIAL_ZONE_AND_PERMANENT_TOOTH("^[1-4][1-8]$|^[1-4]9$|^99$|UR|UL|LR|LL|UA|LA", "牙位限填: 11-19,21-29,31-39,41-49,99,UR,UL,LR,LL,UA,LA"),
    ...
    // All validated
    VALIDATED_ALL("^[1-4][1-8]$|^[5-8][1-5]$|^[1-4]9$|UR|UL|LR|LL|UA|LA|FM", "牙位限填: 11-19,21-29,31-39,41-49,51-55,61-65,71-75,81-85,99,UR,UL,LR,LL,UA,LA,FM"),
