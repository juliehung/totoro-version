 ...
 * 申報OD牙顆數
 */
public class OdToothCount extends SingleSourceMetaCalculator<Long> {

    public OdToothCount(MetricConfig metricConfig, Source<?, ?> source) {
        this(metricConfig, null, source);
    }

    public OdToothCount(MetricConfig metricConfig, MetaConfig config, Source<?, ?> source) {
