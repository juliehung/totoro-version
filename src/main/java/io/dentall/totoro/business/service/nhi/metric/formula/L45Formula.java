...
public class L45Formula extends AbstractFormula<BigDecimal> {
    ...
    public L45Formula(Collector collector,
    ...
    public BigDecimal doCalculate(Collector collector) {
        OdDeciduousReTreatment odDeciduousReTreatment = new OdDeciduousReTreatment(collector, odQuarterSource, odTwoYearNearSource, 1, 730).apply();
