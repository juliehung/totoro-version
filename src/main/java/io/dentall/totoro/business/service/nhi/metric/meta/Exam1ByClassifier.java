...
public class Exam1ByClassifier extends Exam<Map<Long, Long>> {
    ...
    public Exam1ByClassifier(Collector collector, MetaType metaType, String sourceName, Function<NhiMetricRawVM, Long> classifier, boolean use00121CPoint) {
    ...
    public Map<Long, Long> doCalculate(Collector collector) {
        ...
        return calculateByClassifier(source, codesByExam1, classifier, use00121CPoint);
    }
