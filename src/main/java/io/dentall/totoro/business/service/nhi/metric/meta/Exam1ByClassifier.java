...
public class Exam1ByClassifier extends Exam<Map<Long, Long>> {
    ...
    public Exam1ByClassifier(MetricConfig metricConfig, Source<?, ?> source, Function<MetricDisposal, Long> classifier) {
        this(metricConfig, null, source, classifier);
    }

    public Exam1ByClassifier(MetricConfig metricConfig, MetaConfig config, Source<?, ?> source, Function<MetricDisposal, Long> classifier) {
