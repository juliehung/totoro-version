...
/**
 * 三年恆牙重補率
 * 分子：＠date-10＠＠OD-2＠＠deta-12＠
 * 分母：＠date-10＠@OD-1@@tooth-1@
 * (分子 / 分母) x 100%"
 */
public class L35Formula extends AbstractFormula {

    private final Source<OdDto, Map<Long, List<OdDto>>> odQuarterSource;

    private final Source<OdDto, Map<Long, List<OdDto>>> odThreeYearNearSource;

    public L35Formula(Collector collector, Source<OdDto, Map<Long, List<OdDto>>> odQuarterSource, Source<OdDto, Map<Long, List<OdDto>>> odThreeYearNearSource) {
        super(collector);
