...
public class KaoPingDistrictRegularService implements DistrictService {
    ...
    @Override
    public Optional<KaoPingDistrictRegularDto> metric(LocalDate baseDate, User subject, List<? extends NhiMetricRawVM> source, Map<LocalDate, Optional<Holiday>> holidayMap) {
        return ofNullable(buildMetric(baseDate, holidayMap, subject, source));
    }

    public List<KaoPingDistrictRegularDto> metric(LocalDate baseDate, List<User> subjects, List<? extends NhiMetricRawVM> source, Map<LocalDate, Optional<Holiday>> holidayMap) {
    ...
    private KaoPingDistrictRegularDto buildMetric(LocalDate baseDate, Map<LocalDate, Optional<Holiday>> holidayMap, User subject, List<? extends NhiMetricRawVM> source) {
