...
import io.dentall.totoro.business.service.report.dto.ExtractTeethVo;
...
public class ExtractTeethSheet extends ExcelSheet {

    private final Counter rowCounter = new Counter();

    private final ExtractTeethReportSetting setting;

    public ExtractTeethSheet(ExtractTeethReportSetting setting) {
    ...
    public void write() {
        ...
        createNote(sheet);
        createHeader(sheet);
        List<ExtractTeethVo> data = getReport().getData();
        for (ExtractTeethVo vo : data) {
