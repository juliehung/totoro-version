...
/**
 * 符合牙醫門診加強感染管制實施方案之牙科門診診察費(不含Xray)  病患點數(最高者)
 */
public class HighestExam3ByPatient extends Exam3 {

    public HighestExam3ByPatient(Collector collector, String sourceName) {
    ...
    public Long doCalculate(Collector collector) {
        ...
        Map<Long, Long> examPointByPatient = nhiMetricRawVMList.stream()
            ...
            .filter(vm -> codesByExam3.contains(vm.getExamCode()))
    ...
    public MetaType metaType() {
        return MetaType.HighestExam3Patient;
    }
